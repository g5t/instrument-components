...
def declare_array(instrument: ScriptInstrument, element_type: str, name: str, description: str, values):
    try:
...
def ensure_parameter(instrument: ScriptInstrument, data_type: str, name: str, description: str):
